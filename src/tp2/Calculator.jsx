...
const Calculator = () => {
  ...
  return (
    <div className="bg-gray-300 flex z-50 items-center py-[5rem] h-full justify-center  font-mono">
      <div className="bg-gray-100 p-6 rounded-lg shadow-lg  max-w-md w-full">
        ...
        <div className="grid grid-cols-4 gap-2">
          <Button
            label="Clear All"
            onClick={clearAll}
            className="col-span-3 bg-gray-400"
          />
          ...
          <Button
            label="="
            onClick={calculate}
            className="col-span-4 bg-green-400"
          />
        </div>
      </div>
    </div>
